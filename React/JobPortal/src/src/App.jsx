...
import ApplicationUpdates from "./Components/hr/ApplicationUpdates";
...
import UpdateProfileJS from "./Components/jobseeker/UpdateProfile";
import UpdateApplication from "./Components/jobseeker/UpdateApplication";
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/hr" element={<HrDashboard />}>
            ...
            <Route path="application-updates/:appId" element={<ApplicationUpdates />} /> 
          </Route>
          ...
          <Route index element={<JsHome />} />
            ...
            <Route path="updateprofile" element={<UpdateProfileJS />} />
