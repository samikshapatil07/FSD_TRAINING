  ...
  return (
    <div className="offcanvas offcanvas-end" tabIndex="-1" id="profileSidebar" aria-labelledby="offcanvasLabel">
      <div className="offcanvas-header">
        ...
        <button type="button" className="btn-clzose" data-bs-dismiss="offcanvas" aria-label="Close"></button>
      </div>
      <div className="offcanvas-body d-flex flex-column gap-3">
        <button className="btn btn-outline-primary" onClick={() => navigate("/hr/updateprofile")}>Update Profile</button>
